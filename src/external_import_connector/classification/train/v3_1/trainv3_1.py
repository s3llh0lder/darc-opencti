...
data["cleaned_html"] = data["html"].apply(clean_html_and_js)
...
data["augmented_html"] = data["cleaned_html"].apply(augment_text)
...
data["Sentiment Score"] = data["cleaned_html"].apply(calculate_sentiment)
...
data["Keyword Count"] = data["cleaned_html"].apply(
...
data["Obfuscation Level"] = data["cleaned_html"].apply(calculate_obfuscation)
...
X_text = tfidf.fit_transform(data["cleaned_html"]).toarray()
