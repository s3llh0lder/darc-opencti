...
class DataClassifierV31:
    def __init__(self):
        ...
        self.model_path = "./v3_1/model.keras"  # Path to the neural network model
        self.scaler_path = (
            "./v3_1/scaler.pkl"  # Path to the scaler for numerical features
        )
        self.tfidf_path = "./v3_1/tfidf.pkl"  # Path to the TF-IDF vectorizer
...
class DataClassifierSingletonV31:
    """
    Singleton wrapper for the DataClassifierV2 instance.
    """

    _instance: DataClassifierV31 = None
    _lock: Lock = Lock()

    @classmethod
    def get_instance(cls) -> DataClassifierV31:
        """
        ...
        if cls._instance is None:
            with cls._lock:  # Ensure thread safety
                if cls._instance is None:  # Double-checked locking
                    cls._instance = DataClassifierV31()
